                ...
                <div class="card-header">
                    <figure>
                        <blockquote class="blockquote">
                            ...
                            <p>Upload file jadwal</p>
                        </blockquote>
                        <figcaption class="blockquote-footer">
                            Menampilkan proses <cite title="Source Title">upload jadwal</cite>
                        </figcaption>
                    </figure>
                </div>
                <div class="card-body">
                    <?= form_open_multipart('adminpanel/editFileJadwal'); ?>
                    <div class="row mb-3 mt-3">
                        <label for="formFile" class="col-sm-2 col-form-label">File Jadwal</label>
                        <div class="col">
                    ...
                    <div class="d-grid gap-2">
                        <button type="submit" name="edit" class="btn btn-success">Perbarui Jadwal</button>
                    </div>
                    </form>
                </div>
            </div>
