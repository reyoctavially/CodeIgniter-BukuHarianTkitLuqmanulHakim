    ...
    <div class="container">
        ...
        ?>
            <div class="row mt-3">
                <div class="col-md-6">
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        Data jadwal <strong>berhasil</strong> <?= $this->session->flashdata('flash2'); ?>.
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-10">
                <figure>
                    ...
                    <figcaption class="blockquote-footer">
                        Menampilkan data file <cite title="Source Title">jadwal</cite> untuk ditampilkan pada buku penghubung.
                    </figcaption>
                </figure>
            </div>
        </div><br>
        <table id="file" class="table table-striped table-hover">
            <caption>Tabel data file jadwal</caption>
            <thead>
                <tr>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary float-end" href="<?= base_url(); ?>adminpanel/editFileJadwal/<?= $fl['kode_file']; ?>">Upload Jadwal Baru</a>
                            <a class="btn btn-success float-end" href="<?= base_url(); ?>adminpanel/detailFileJadwal/<?= $fl['kode_file']; ?>">Lihat Jadwal</a>
                        </td>
                    </tr>
                <?php
                endforeach;
