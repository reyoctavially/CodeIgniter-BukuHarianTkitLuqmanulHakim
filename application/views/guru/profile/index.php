		...
		<div class="card mb-3" style="max-width: 540px;">
			<div class="row g-0">
				<div class="col-md-4">
					...
					<hr>
					<a class="btn btn-primary" style="width: 100%;" href="<?= base_url(); ?>profile/guru_edit/<?= $login['nip']; ?>">Edit</a>
					<a class="btn btn-success mt-2" style="width: 100%;" href="<?= base_url(); ?>profile/guru_password/<?= $login['nip']; ?>">Ganti Kata Sandi</a>
					<a class="btn btn-danger mt-2" style="width: 100%;" onclick="return confirm('Apakah anda yakin akan logout?');" href="<?= base_url(); ?>guru/logout">Logout</a>
					<hr>
				</div>
				<div class="col-md-8">
					<div class="card-body">
