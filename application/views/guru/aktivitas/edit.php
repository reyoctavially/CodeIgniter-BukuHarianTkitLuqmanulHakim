			...
			<div class="card mb-3">
				...
				<div class="card-body">
					<form class="row g-3" action="" method="POST">
						...
						<div class="row mb-3">
							<label for="colFormLabel" class="col-sm-2 col-form-label">Catatan guru</label></label>
							<div class="col">
								<input type="text" name="catatan_guru" class="form-control" id="colFormLabel" value="<?= $aktivitas['catatan_guru']; ?>">
