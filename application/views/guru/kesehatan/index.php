    ...
    <div class="container">
        ...
        <div class="row flex-lg-row align-items-center">
            ...
            <div class="col-lg-10">
                ...
                <a href="<?= base_url(); ?>kesehatan/guru_tambah_pertumbuhan" class="btn btn-success">Tambah Data Pertumbuhan</a>
            </div>
        </div><br>
        <table class="table table-striped table-hover">
            <tr>
                <td colspan="6">
                    <form  class="row g-2" method="POST" action="<?= base_url('kesehatan/cetak_pertumbuhan') ?>">
                        <div class="col md-4">
                        ...
                        <div class="col-12">
                            <button type="submit" name="cetak" class="btn btn-primary" style="width: 100%;">Cetak Pertumbuhan Siswa</button>
                        </div>
                    </form>
                </td>
            </tr>
                ...
                foreach ($pertumbuhan as $avs) :
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-success float-end m-1" href="<?= base_url(); ?>kesehatan/guru_detail_pertumbuhan/<?= $avs['kode_pertumbuhan']; ?>">Rincian</a>
                            <a class="btn btn-primary float-end m-1" href="<?= base_url(); ?>kesehatan/guru_edit_pertumbuhan/<?= $avs['kode_pertumbuhan']; ?>">Edit</a>
                        </td>
                    </tr>
                    <?php
                endforeach;
        ...
        <a href="<?= base_url(); ?>kesehatan/guru_tambah_perkembangan" class="btn btn-success mb-4">Tambah Data Perkembangan</a>
        <table class="table table-striped table-hover">
            <tr>
                <td colspan="6">
                    <form  class="row g-2" method="POST" action="<?= base_url('kesehatan/cetak_perkembangan') ?>">
                        <div class="col md-4">
                            <label for="namaSiswa" class="form-label">Nama siswa</label>
                            <select class="form-select" aria-label="namaSiswa" id="colFormLabel" name="nis">
                                <?php foreach($siswa as $sw) : ?>
                        ...
                        <div class="col-12">
                            <button type="submit" name="cetak" class="btn btn-primary" style="width: 100%;">Cetak Perkembangan Siswa</button>
                        </div>
                    </form>
                </td>
            </tr>
            ...
            <tbody>
                ...
                foreach ($perkembangan as $avs) :
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-success float-end m-1" href="<?= base_url(); ?>kesehatan/guru_detail_perkembangan/<?= $avs['kode_pemeriksaan']; ?>">Rincian</a>
                            <a class="btn btn-primary float-end m-1" href="<?= base_url(); ?>kesehatan/guru_edit_perkembangan/<?= $avs['kode_pemeriksaan']; ?>">Edit</a>
                        </td>
                    </tr>
                    <?php
                endforeach;
