<main class="form-signin">
	<form method="POST" action="<?= base_url('auth') ?>">
		...
		<div class="form-group">
			...
			<input type="email" id="inputUsername" name="email_orang_tua" class="form-control" placeholder="Email" value="<?= set_value('email_orang_tua') ?>" required>
			<small class="form-text text-danger"><?= form_error('email_orang_tua'); ?></small>
		</div>

		<div class="form-group">
			<label for="inputPassword" class="visually-hidden">Password</label>
			<input type="password" id="inputPassword" name="pass_orang_tua" class="form-control" placeholder="Kata sandi" required="">
	...
	<hr>
	<a class="small text-success" style="text-decoration: none;" href="<?= base_url('auth/forgotPassword') ?>">Lupa kata sandi?</a>
