	...
	<div class="row mt-3">
		<div class="col-md-7">
			<div class="card">
				...
				<div class="card-body">
					<?php
					if ($monitoring['review'] == 1) {
					?>
						<img src="<?= base_url(); ?>assets/icon/check.png" class="float-end" style="width: 50px; height: 50px;">
					<?php
					} else {
					?>
						<img src="<?= base_url(); ?>assets/icon/uncheck.png" class="float-end" style="width: 50px; height: 50px;">
					<?php
					}
					?>
